      ...
      if (document.activeElement === input) {
        ...
        if (r) {
          const origin = {
            ...
            standard: "标准字体",
            "system-name": "本机同名字体",
            "metric-substitute": "度量近似字体",
            unresolved: "原字体未解析",
          };
          const badge = bar.querySelector("#pe-font-source");
          badge.textContent = origin[r.fontResolution] || "所选字体";
          badge.title =
            r.fontFallback || r.fontOriginalName || r.fontName || "";
          const names = new Set(
            (model.runs || [])
